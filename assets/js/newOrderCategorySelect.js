const selectedTextService  = document.querySelector('.selectedTextService');
const selectService = document.querySelector('.selectForService')
const selectionsForCategoryService = document.querySelectorAll('.selectionsForService li')
const selectionsForCategorySelectService = document.querySelector('.selectionsForService')
